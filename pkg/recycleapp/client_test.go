...
func TestGetOrganization(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		org, err := c.GetOrganization(context.Background(), "12345")
		if err != nil {
	...
	t.Run("empty response name", func(t *testing.T) {
		...
		c := NewClient(httpClient)
		_, err := c.GetOrganization(context.Background(), "12345")
...
func TestGetStreetID(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		c := NewClient(httpClient)
		id, err := c.GetStreetID(context.Background(), "12345", "Main Street")
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	...
	t.Run("no items", func(t *testing.T) {
		...
		c := NewClient(httpClient)
		_, err := c.GetStreetID(context.Background(), "12345", "Main Street")
...
func TestGetZipcodeID(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		c := NewClient(httpClient)
		id, err := c.GetZipcodeID(context.Background(), 1000)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	...
	t.Run("no items", func(t *testing.T) {
		...
		c := NewClient(httpClient)
		_, err := c.GetZipcodeID(context.Background(), 1000)
